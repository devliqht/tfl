...
const teamMembers = [
  ...
  { name: "Derick Angelo Yu", img: "/jhanell.jpg" },
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-10">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="bg-gray-200 shadow-lg rounded-lg p-6 flex flex-col items-center transition-transform transform hover:scale-105"
            >
