    ...
    return (
        <div className="flex flex-col gap-2 p-4 border-[1px] rounded-xl border-gray-700">
            <div className="flex flex-col md:flex-row md:gap-8 items-center">
                <p className="text-black flex flex-row gap-4 items-center lexend-deca-700"><FaPen />Written by</p>
                <div className="text-red-600 ibm-plex-mono-bold">{author}</div>
            </div>
            <div className="flex flex-col md:flex-row md:gap-8 items-center">
                <p className="text-black flex flex-row gap-4 items-center lexend-deca-700"><FaCalendar />Last Edited On</p>
